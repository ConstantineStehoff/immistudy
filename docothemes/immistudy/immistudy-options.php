...
function director_register_settings() {
	...
	register_setting( 'director-settings-group', 'director_applicationImage' );
...
<form id="landingOptions" method="post" action="options.php">
    ...
    <table class="form-table">
        ...
        <tr valign="top">
        <th scope="row">Application Image:</th>
        <td>
        	<input type="text" name="director_appImage" value="<?php print get_option('director_appImage'); ?>" /><br/>
        	*Upload using the Media Uploader and paste the URL here.
        </td>
        </tr>
