...
<body <?php body_class(); ?>>
	...
	<header role="banner">
		<div class="grid">
			...
			<div>		
				<div class="header-contacts margin_left margin_right">
					...
					<p class="header-phones"><span class="phone"></span><strong class="margin_left_half blue"><?php echo $phone; ?></strong></p>
				</div>
				...
				<div class="header-contacts">
					...
					<p class="header-cities alignright"><a href="#" class="blue"><span class="city"></span><span class="margin_left_half blue"><?php echo $display_city; ?></span></a></p>
				</div>
